      ...
      <div className="mb-2 flex items-center gap-2">
        ...
        {activeTopic ? (
          <button
            ...
            className="ml-auto inline-flex items-center gap-1 rounded border border-rule px-1.5 py-0.5 text-[11px] text-text-dim transition-colors hover:border-accent-border hover:text-text"
          >
          ...
          return (
            ...
            >
              ...
              >
                ...
                />
                {t.name}
                <span className="font-mono text-[10px] text-text-faint">{t.count}</span>
              </Link>
              <button
                type="button"
