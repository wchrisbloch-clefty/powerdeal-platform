...
const SPECS: SeedSpec[] = [
  ...
  { deal_id: 'OG-004', company: 'PBF Energy', vertical: 'O&G-Down', state: 'LA', utility: null, value_prop: 'Combustion-fighter', geo_tier: 'Secondary' },
  { deal_id: 'OG-005', company: 'Energy Transfer', vertical: 'O&G-Mid', state: 'TX', utility: 'Oncor', value_prop: 'Grid-fighter', geo_tier: 'Primary' },
  { deal_id: 'OG-006', company: 'Williams Companies', vertical: 'O&G-Mid', state: 'OK', utility: null, value_prop: 'Grid-fighter', geo_tier: 'Secondary' },
  { deal_id: 'OG-007', company: 'Kinder Morgan', vertical: 'O&G-Mid', state: 'TX', utility: 'CenterPoint', value_prop: 'Grid-fighter', geo_tier: 'Primary' },
  { deal_id: 'OG-008', company: 'Targa Resources', vertical: 'O&G-Mid', state: 'TX', utility: 'Oncor', value_prop: 'Grid-fighter', geo_tier: 'Primary' },
